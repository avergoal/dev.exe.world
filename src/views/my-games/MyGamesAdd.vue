        ...
        <div class="context">
            ...
            <form action="" @submit.prevent="addGame">
                <div class="inputs">
                    ...
                    <v-text-area @update:modelValue="description = $event"> Description</v-text-area>
                    <v-select @update:modelValue="type = $event" :data="genres" showSelect="title" id-type="cid">Choose
                        genre
                    </v-select>
                </div>
                <div class="rules">
                    <v-checkbox @update:modelValue="agree = $event">I agree with the
                        <template #violet>
                            <router-link to="/"
