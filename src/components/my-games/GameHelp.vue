...
<template>
    <div class="help-content">
        <h1>Help</h1>
        <div class="help">
            <v-input limit="100" @update:modelValue="title = $event" :error="error.title"
                >Title
            </v-input>
            <v-input @update:modelValue="mail = $event" :error="error.mail">Email </v-input>
            <v-input @update:modelValue="name = $event" :error="error.name">Name </v-input>
            <v-text-area @update:modelValue="text = $event" :error="error.text"
